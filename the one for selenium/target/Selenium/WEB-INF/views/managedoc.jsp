...
<div id="layout">
    ...
    <div class="content">
        ...
        <div class="content-head is-center">
            ...
            <button class="button-secondary pure-button" onclick="location.href='/Selenium/script/${document.id}/result';"><i
                ...
                <div class="pure-u-1 pure-u-md-2-5">
                    <form:form class="pure-form pure-form-stacked" modelAttribute="fileChange" method="post">
                        ...
                        <div class="pure-u-1">
                            ...
                            <form:textarea id="content" path="content" maxlength="10000" rows="10" cols="105"
                                           readonly="true"/>
                            <div class="has-error">
