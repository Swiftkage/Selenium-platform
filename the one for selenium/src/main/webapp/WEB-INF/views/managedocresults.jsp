...
<div id="layout">
    ...
    <div class="content">
        ...
        <div class="pure-u-1 pure-u-md-2-5">
            ...
            <br/>
            <br/><a class="pure-button pure-button-grey" href='/Selenium/script/${document.id}'>Back</a>
                <a id="divider" class="pure-button pure-button-grey" href='/Selenium/script/${document.id}/deleteresults'>Clear results</a>
